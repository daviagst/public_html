...
!(function (t, e) {
  ...
  class et extends q {
    ...
    to(t) {
      ...
      const e = this._getItemIn(this._activeElement);
  ...
  const Ct = new Set([
    ...
    Lt =
      /^data:(?:image\/(?:bmp|gif|jpeg|webp|webp|tiff|webp)|video\/(?:mpeg|webm|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,[\d+/a-z]+=*$/i,
    Ot = (t, e) => {
